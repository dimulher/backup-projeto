                        ...
                        <div className="space-y-2" ref={isVideoMode ? resDropdownRef : imgFormatDropdownRef}>
                            ...
                            <div className="relative">
                                <button
                                    ...
                                    disabled={isGenerating}
                                    className={`w-full flex items-center justify-between bg-[#0B1220] border border-[#8C5CFF]/25 rounded-xl px-2 py-3.5 text-xs font-bold text-[#E6E8EE] outline-none transition-all shadow-sm group ${(isVideoMode ? isResDropdownOpen : isImgFormatDropdownOpen) ? 'ring-1 ring-[#8C5CFF]/50 border-[#8C5CFF]/50' : 'hover:border-[#8C5CFF]/50'
                                        }`}
                                >
                                    <span className="truncate mr-1">
                                        {isVideoMode ? videoResolution : format}
                                    </span>
                                    <svg className={`w-3 h-3 text-[#8C5CFF] transition-transform duration-200 ${(isVideoMode ? isResDropdownOpen : isImgFormatDropdownOpen) ? 'rotate-180 text-[#A78BFA]' : 'group-hover:text-[#A78BFA]'
