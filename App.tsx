...
import LibraryScreen from './components/LibraryScreen'; // Import LibraryScreen
...
const App: React.FC = () => {
  ...
  const handleLogin = useCallback((email: string, name?: string) => setUser({ email, name, credits: 150 }), []);
                   ...
                   visibleLayersList.map((block) => {
                     ...
                     return (
                        <div 
                          ...
                          `}
                        >
                          <div className={`w-9 h-9 rounded-lg flex items-center justify-center overflow-hidden border shrink-0 transition-colors shadow-sm ml-1 ${
                            isActive 
